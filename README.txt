...
bitnami-wampstack-8.1.11-0-windows-installer.exe
...
path will be a folder at C:\Bitnami\wampstack-8.1.11-0. If the destination 
...
C:\Bitnami\wampstack-8.1.11-0 and that you use port 80 for Apache and 3306 for MariaDB.
